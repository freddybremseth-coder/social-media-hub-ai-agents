 ...
 * Basert på dine 4 forretninger, ikke separate mennesker
 */
...
// SPARANVENDELSE - Én Marketing Agent med 4 Business-Moduler
export const DOMAIN_EXPERT_MODULES = {
  // MODUL 1: EIENDOM ESPAÑA
  realestate: {
    ...
    skillParameters: {
      ...
      local_markets: ['Málaga', 'Costa del Sol', 'Valencia'],
